    ...
    def do_create(self, args):
        ...
        if len(arg) == 1 and '=' not in arg[1]:
            ...
            for argument in arg[1:]:
                ...
                if key.startswith('__') and key.endswith('__') or \
                   key not in HBNBCommand.classes[arg[0]].__dict__:
                    continue

                # check if second element has . or "
                new_val = arg_list[0][1]
            ...
            # pass new_dict as kwarg to classes
            print(new_instance.id)
            new_instance.save()
